...
function metaFor(name: string, preposition: "i" | "på") {
  return `Leder du efter en fotograf ${preposition} ${name}? Foto, video og drone til konfirmationer, bryllup, sport, events, koncerter og virksomheder. Kontakt mig for et uforpligtende tilbud.`;
}
...
const cityDefinitions = [
  buildCity({
    ...
    region: "Syddanmark",
    intro:
      "Jeg er baseret i Grindsted og arbejder lokalt med foto, video og drone — til private fester, sport, events, koncerter, erhverv og alt derimellem.",
    servicesIntro:
  ...
  buildCity({
    ...
    servicesIntro:
      "Vejle har et aktivt kultur- og erhvervsliv — jeg leverer foto, video og drone til alt fra konfirmationer og bryllup til kampdækning og koncertfoto.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Uanset om det er street food-event, sportskamp eller virksomhedsindhold — jeg leverer foto, video og drone i Esbjerg med fokus på mennesker og stemning.",
  ...
  buildCity({
    ...
    servicesIntro:
      "Horsens har et stærkt kultur- og eventmiljø — jeg dokumenterer det med billeder og video til både private og professionelle projekter.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Fra private festlige arrangementer til sportsdækning og virksomhedsvideo — jeg dækker Odense med foto, video og drone efter projektets behov.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Silkeborg er ideel til både udendørs portrætter og indendørs events — jeg tilpasser foto, video og drone til dit projekt og din tidsplan.",
  }),
  buildCity({
    slug: "fotograf-vejen",
    name: "Vejen",
  ...
  buildCity({
    ...
    servicesIntro:
      "Ribes stemningsfulde miljø giver unikke muligheder for foto og video — jeg fanger både detaljer og helhed med et professionelt udtryk.",
  }),
  buildCity({
    ...
    servicesIntro:
      "Brande ligger tæt på mit udgangspunkt i Grindsted — jeg tilbyder hurtig tilgængelighed og professionelt foto, video og drone i området.",
  }),
  buildCity({
    slug: "fotograf-ikast",
    name: "Ikast",
  ...
  buildCity({
    ...
    servicesIntro:
      "Middelfart er let tilgængeligt fra Jylland — jeg leverer foto, video og drone til både lokale virksomheder og private kunder i området.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Skanderborg har et aktivt lokalmiljø for sport og kultur — jeg leverer billeder og video, der fanger energien og detaljerne.",
  }),
  buildCity({
    ...
    servicesIntro:
      "Hedensted ligger strategisk mellem større byer — jeg dækker området med foto, video og drone til både små og større projekter.",
  }),
  buildCity({
    slug: "fotograf-give",
    name: "Give",
  ...
  buildCity({
    ...
    servicesIntro:
      "Varde og vestkysten giver unikke locations til foto og drone — jeg leverer materiale til events, virksomheder og private projekter.",
  }),
  buildCity({
    ...
    servicesIntro:
      "Ringkøbing og omegn dækkes med foto, video og drone — fra konfirmationer og bryllup til virksomhedsindhold og eventdækning.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Grenaa og Djursland er en del af mit dækningsområde — jeg leverer foto, video og drone til lokale og regionale projekter.",
  }),
  buildCity({
    ...
    servicesIntro:
      "Sønderborg og Als dækkes med professionelt foto og video — fra portrætter og konfirmationer til event- og sportsdækning.",
  }),
  buildCity({
  ...
  buildCity({
    ...
    servicesIntro:
      "Randers er let tilgængeligt fra mit udgangspunkt — jeg leverer kampdækning, eventfoto, videoproduktion og drone efter behov.",
  }),
  buildCity({
    ...
    preposition: "i",
    intro:
      "Fotograf i Jylland — baseret i Grindsted dækker jeg Midt- og Syddanmark med foto, video og drone til private, sport, events og erhverv.",
    servicesIntro:
      "Fra Vestkysten til Østjylland — konfirmationer, bryllup, sportsdækning, koncertfoto, virksomhedsindhold og droneproduktion i hele Jylland.",
  }),
  buildCity({
    slug: "fotograf-fyn",
    name: "Fyn",
    ...
    servicesIntro:
      "Jeg tager opgaver på Fyn med foto, video og drone — planlagt efter location, tidsplan og det visuelle udtryk, du ønsker.",
  }),
  buildCity({
    ...
    preposition: "på",
    intro:
      "Fotograf på Sjælland — udvalgte opgaver med foto, video og drone til private, sport, events og erhverv efter aftale.",
    servicesIntro:
