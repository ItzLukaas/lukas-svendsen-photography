...
const projectSeed: Project[] = [
  ...
  },
  {
    ...
    year: "2026",
    location: "Esbjerg",
    excerpt: "Sivas · Grøn Koncert, Esbjerg",
    client: "Grøn Koncert",
    role: "Fotograf",
    outcome: "Koncertfoto fra Sivas' optræden til Grøn Koncert i Esbjerg.",
    featured: true,
    cover: P(
  ...
  },
  {
    ...
    role: "Sportsfotograf",
    outcome:
      "Kampbilleder fra finalen i Aarhus, action, jubel og pokaløjeblikket.",
    featured: true,
    cover: L(
  ...
  },
  {
    ...
    role: "Sportsfotograf",
    outcome:
      "Kampbilleder fra finalen i Esbjerg, intensitet, jubel og mesterskabsøjeblikket.",
    featured: true,
    cover: L(
  ...
  },
  {
    ...
    role: "Sportsfotograf",
    outcome:
      "Kampdækning fra Super Cup i Arena Randers, Team Esbjerg vandt finalen.",
    featured: true,
    cover: L(
  ...
  },
  {
    ...
    role: "Sportsfotograf",
    outcome:
      "Kampdækning fra Super Cup i Arena Randers, Aalborg Håndbold løftede pokalen.",
    featured: true,
    cover: L(
