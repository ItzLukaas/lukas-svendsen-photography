  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center text-center">
        <h2
          id="clients-heading"
          className="font-display max-w-2xl text-xl font-light leading-tight text-foreground sm:text-2xl md:text-3xl"
        >
          Betroet fotograf for førende brands
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-xs leading-relaxed text-muted sm:text-sm">
        ...
        <Link
          href="/referencer"
          className="group mt-5 inline-flex min-h-9 items-center gap-2 text-[10px] tracking-[0.2em] text-muted uppercase transition-colors duration-500 ease-premium hover:text-foreground"
        >
