...
export const approachPoints = [
  ...
  {
    title: "Optagelse",
    description: "Jeg optager på den lokation vi har planlagt.",
...
export const photographyTypes = [
  {
    ...
    examples: [
      ...
      "SoMe-indhold og stories",
      "Produkt- og lokationsbilleder",
    ],
  },
  {
...
export const processSteps = [
  {
    step: "01",
    title: "Kontakt",
    description: "Fortæl mig kort om dit projekt.",
  },
  {
    step: "02",
    title: "Planlægning",
    description: "Vi finder den rigtige løsning og lokation.",
  },
  {
    step: "03",
    title: "Produktion",
    description: "Optagelser på ønsket lokation.",
  },
  {
    step: "04",
    title: "Levering",
...
export const testimonials = [
  ...
  {
    quote:
      "En behagelig oplevelse fra start til slut. Resultatet overgik vores forventninger.",
    author: "Eksempel — Kunde",
  },
];
