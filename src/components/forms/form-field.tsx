...
export const fieldClass =
  "h-12 w-full rounded-none border-0 border-b border-foreground/20 bg-transparent px-0 text-base shadow-none transition-[border-color] duration-300 placeholder:text-muted-ink/50 focus-visible:border-foreground focus-visible:ring-0 md:text-[0.95rem]";
